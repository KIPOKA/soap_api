    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ProductPort port = service.getProductPortPort();
             if (request.getParameter("select").equals("add")) {
                ...
                out.println("<h1> product added"+ port.insert(product)+ "<h1/>");
            }
             else{
                 out.println("<h1>Servlet product at " + port.getProduct(Integer.parseInt(request.getParameter("id"))).getName() +"<h1/>");
             }
