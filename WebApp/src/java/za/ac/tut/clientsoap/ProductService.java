 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://webservice.tut.ac.za/", wsdlLocation = "http://localhost:9897/productwebservice/product?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://webservice.tut.ac.za/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9897/productwebservice/product?wsdl");
     ...
     *     returns ProductPort
     */
    @WebEndpoint(name = "ProductPortPort")
    public ProductPort getProductPortPort() {
        return super.getPort(new QName("http://webservice.tut.ac.za/", "ProductPortPort"), ProductPort.class);
    }
     ...
     */
    @WebEndpoint(name = "ProductPortPort")
    public ProductPort getProductPortPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.tut.ac.za/", "ProductPortPort"), ProductPort.class, features);
    }
